...
load([pwd filesep 'data' filesep 'LRP_MACRO_X_DBA_PwMSmild.mat']);
LRP=double(LRP); %ensure that LRP is a double precision array
load([pwd filesep 'results' filesep 'X_DBA_PwMSmild.mat'])
...
options.save_name='LRP_DBA_PwMSmild';
...
options.black_key=20;           %Set the amount of non-relavant LRP values to be plotted; 
                                %(higher black key denotes more harsh
                                %filtering of LRP values around zero);
%--------------------------------------------------------------------------
